...
feature 'user votes review on item show page', %{
  ...
  scenario 'user upvotes on review', focus: true, js: true do
  ...
  scenario 'user downvotes on review', focus: true, js: true do
    category = FactoryGirl.create(:category)
    user = FactoryGirl.create(:user)
    item = FactoryGirl.create(:item, user: user, category: category)
    review = FactoryGirl.create(:review, item: item)
  ...
  scenario 'user votes the same vote on review twice', focus: true, js: true do
    category = FactoryGirl.create(:category)
    user = FactoryGirl.create(:user)
    item = FactoryGirl.create(:item, user: user, category: category)
    review = FactoryGirl.create(:review, item: item)
  ...
  scenario 'user changes vote on review', focus: true, js: true do
    category = FactoryGirl.create(:category)
    user = FactoryGirl.create(:user)
    item = FactoryGirl.create(:item, user: user, category: category)
    review = FactoryGirl.create(:review, item: item)
  ...
  scenario 'multiple users vote on review', focus: true, js: true do
    category = FactoryGirl.create(:category)
